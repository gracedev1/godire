...
<head>
    <title><? echo lang('create_new_account'); ?> | Godire</title>
    <meta charset="UTF-8">
    ...
    <meta name="keywords" content="signup,social network,social media,Godire,meet,free platform">
    ...
    <div align="center">
        ...
        <!--============[ sign up sec ]============-->
            ...
            <p><input style="width:350px; type="text" name="signup_fullname" class="login_signup_textfield" id="fn" placeholder="Seller/Buyer or Producer/Consumer (please indicate)"></p>
