...
<head>
    ...
    <meta name="keywords" content="social network,social media,Godire,meet,free platform">
...
<!--====================================[ Center col3 ]============================================-->
        <div align="left">
         <div id="centerCol3" style="width: 310px">
          ...
          <div class="trendingTitle_CenterCol_3" style="background: #e9ebee;"> <a href="#" id="trPostsTab"><p> product categories </p></a></div>
...
<div>
    <div class="container">
        <button>Click here for Payment</button>
    </div>
</div>
<!--===============================[ End ]==========================================-->
