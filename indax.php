...
<head>
    <title><? echo lang('welcome'); ?> | Godire</title>
    <meta charset="UTF-8">
    <meta name="description" content="Godire is a social network platform helps you meet new friends and stay connected with your family and with who you are interested anytime anywhere.">
    <meta name="keywords" content="homepage,main,login,social network,social media,Godire,meet,free platform">
    ...
    <!--============[ Nav bar ]============-->
        <div class="login_signup_navbar">
                <a href="index.html" class="login_signup_navbarLinks">Home</a>
        ...
        <h3 align="center"><? echo lang('welcome_to'); ?> Godire</h3>
        <h4 align="center" style="color: black;"> Connect with Buyers , Sellers , Producers and Consumers for easy Business Transactions</h4>
